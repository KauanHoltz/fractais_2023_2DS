 ...
 /*Dibujar línea */
 function drawLine (pO, p1, color = "black") {
 ctx.beginPath();
...
drawTriangle (p0, p1, p2);
 ...
 /*Limpia la imagen y vuelve a dibujar con el nivel
 especificado* /
 function actualizarFractal (val) {
 document.getElementByld("textInput").value = val;
 document.getElementByld("niveles").value = val;
 document.getElementByld("cant").innerHTML = 3 ** parselnt(val);
